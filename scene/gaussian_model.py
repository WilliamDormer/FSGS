...
from utils.general_utils import strip_symmetric, build_scaling_rotation, chamfer_dist, get_minimum_axis, flip_align_view 
...
class GaussianModel:
    ...
    # New Shader Args
    def __init__(self, sh_degree : int, brdf_dim : int, brdf_mode : str, brdf_envmap_res: int, args):
         # New Shader
...
# ==================================================================
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_roughness, new_specular, new_normal, new_normal2):
    ...
    def proximity(self, scene_extent, N = 3):
        ...
        # My own choice: New Gaussians inherit destination properties
        new_roughness = self._roughness[new_indices] if self.brdf else None
        new_specular = self._specular[new_indices] if self.brdf else None
        new_normal = self._normal[new_indices] if self.brdf else None
        new_normal2 = self._normal2[new_indices] if (self.brdf) else None
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation, new_roughness, new_specular, new_normal, new_normal2)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation, new_roughness, new_specular, new_normal, new_normal2)
