...
def pipeline(scene, base_path, n_views):
    ...
    os.mkdir('images')
    # Assumes that camera.bin, images.bin, points.bin exist in ../sparse/0/
...
pipeline('croissant_1', base_path = '/home/dbromley/FSGS/dataset/meta_food_3d/', n_views = 3)  # please use absolute path!
